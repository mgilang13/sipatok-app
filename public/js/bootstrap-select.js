...
!(function(a, b) {
    ...
    !(function(a) {
        ...
        (x.VERSION = "1.13.1"),
            ...
            "4" === t.major &&
                ((x.DEFAULTS.style =
                    "btn-primary text-white rounded mb-5 btn-sm py-2"),
                (x.DEFAULTS.iconBase = ""),
                ...
                createDropdown: function() {
                    var b =
                        ...
                        h =
                            ...
                            b +
                            '"><button type="button btn-sm" class="' +
                    ...
                    this.$button.on("click.bs.dropdown.data-api", function() {
                        ...
                        this.$searchbox.on("input propertychange", function() {
                            ...
                            if (
                                ...
                                a._$lisSelected = a.$menuInner.find(
                                    ".selected"
                                );
                                for (
                                    var e = 0;
                ...
                changeAll: function(a) {
                    if (this.multiple) {
                        ...
                        for (
                            ...
                            var h = this.selectpicker.current.map.originalIndex[
                                    g
                                ],
                                i = b[h];
                            i &&
