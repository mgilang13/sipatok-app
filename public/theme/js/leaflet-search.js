...
(function (factory) {
    ...
    L.Control.Search = L.Control.extend({
        ...
        options: {
            ...
            autoCollapseTime: 5000, //delay for autoclosing alert and collapse after blur
        ...
        onAdd: function (map) {
            ...
            this._tooltip = this._createTooltip("list-group");
        ...
        _createTip: function (text, val) {
            ...
            L.DomUtil.addClass(tip, "list-group-item");
        ...
        _searchInLayer: function (layer, retRecords, propName) {
            ...
            if (layer instanceof L.Marker || layer instanceof L.CircleMarker) {
                if (self._getPath(layer.options, propName)) {
                    ...
                    console.warn(
                        "propertyName '" + propName + "' not found in marker"
                    );
                }
            } else if (
                ...
                if (self._getPath(layer.options, propName)) {
                    ...
                    console.warn(
                        "propertyName '" + propName + "' not found in shape"
                    );
                }
        ...
        _handleKeypress: function (e) {
            ...
            switch (e.keyCode) {
                ...
                default:
                    ...
                    else this._cancel.style.display = "block";
        ...
        _defaultMoveToLocation: function (latlng, title, map) {
            ...
            // Update form latitude and langitude
